...
import { Calendar, Paperclip, MessageSquare, Trash2, X, User, Maximize2, Minimize2 } from "lucide-react";
...
export const TaskDetailDialog = ({
  ...
  return (
    <Sheet open={open} onOpenChange={onOpenChange}>
      <SheetContent 
        side="right"
        className={`p-0 ${isExpanded ? 'w-full max-w-full' : 'w-[800px] max-w-[90vw]'} transition-all duration-300 ease-in-out overflow-hidden flex flex-col`}
      >
        {/* Header */}
        <div className="px-8 pt-8 pb-6 border-b border-border/30 flex-shrink-0">
          <div className="flex items-start justify-between gap-4 mb-6">
            ...
            <div className="flex items-center gap-2">
              <Button
                ...
                className="text-muted-foreground hover:bg-muted/50 rounded-lg transition-colors"
              >
          ...
          <div className="px-8 py-6 space-y-8">
            ...
            <div className="space-y-3 pb-32">
              ...
              <Textarea
                ...
                placeholder="Start writing your notes, documentation, or thoughts here..."
                className="min-h-[400px] resize-none border-0 focus-visible:ring-0 text-base leading-relaxed placeholder:text-muted-foreground/50"
              />
            </div>
          </div>
        </div>
