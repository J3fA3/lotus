...
DEFAULT_SHORTCUTS: List[Dict[str, Any]] = [
    ...
    },
    {
        ...
        "modifiers": ["ctrl"],
        "enabled": True,
        "description": "Toggle between peek/expanded/full screen views",
    },
    {
    ...
    },
    {
        "id": "dialog_tab_prev",
        "category": "dialog",
        "action": "tab_prev_section",
        "key": "Tab",
        "modifiers": ["alt", "shift"],
        "enabled": True,
        "description": "Tab to previous section in task dialog",
    },
]
